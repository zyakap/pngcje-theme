...
while ( have_posts() ) : the_post();
    ...
    $department  = $departments && ! is_wp_error( $departments ) ? $departments[0] : null;
    ?>
                ...
                <aside class="profile-sidebar">
                    <div class="profile-card">
                        ...
                        <div class="profile-card__body">
                            ...
                            <?php endif; ?>
                            <?php if ( $department ) : ?>
                                <span class="badge badge--green"><?php echo esc_html( $department->name ); ?></span>
                            <?php endif; ?>
                ...
                <div class="profile-main">
                    <div class="entry-content profile-content">
                        <?php if ( get_the_content() ) : ?>
                            <?php the_content(); ?>
                        <?php else : ?>
                            <p><?php esc_html_e( 'Profile details will be added soon.', 'pngcje' ); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    if ( $related->have_posts() ) :
                        ...
                        <section class="profile-related">
                            <div class="section-label"><?php esc_html_e( 'More Staff', 'pngcje' ); ?></div>
                            <div class="profile-related__grid">
                                <?php while ( $related->have_posts() ) : $related->the_post(); ?>
                                    <a href="<?php the_permalink(); ?>" class="card profile-related__card">
                                        <strong><?php the_title(); ?></strong>
                                        <?php $related_role = get_post_meta( get_the_ID(), '_pngcje_staff_role', true ); ?>
                                        <?php if ( $related_role ) : ?>
...
.profile-card__role{font-size:var(--size-sm);font-weight:700;color:var(--ember-primary);line-height:1.45;margin-bottom:1rem}
