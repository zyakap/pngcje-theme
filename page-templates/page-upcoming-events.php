...
<div <?php pngcje_page_hero_attrs(); ?>>
    <div class="container">
        ...
        <div class="section-label" style="margin-bottom:.75rem;">Events</div>
        ...
        <?php else : ?>
            <div class="card" style="margin-bottom:3rem;">
                <div class="card__body" style="text-align:center;padding:2.5rem;">
                    ...
                    <a href="<?php echo esc_url( home_url( '/prospectus/training-calendar/' ) ); ?>" class="btn btn-primary btn-arrow">View Training Calendar</a>
                </div>
            </div>
        <?php endif; ?>
        <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:1.25rem;">
            <a href="<?php echo esc_url( home_url( '/prospectus/training-calendar/' ) ); ?>" class="card" style="display:block;text-decoration:none;border-top:3px solid var(--ember-primary);"><div class="card__body"><h3 style="color:var(--ember-primary);font-size:var(--size-base);">Training Calendar</h3><p style="color:var(--ink-light);font-size:.88rem;line-height:1.65;margin:0;">View the broader annual schedule by topic, recipient group and location.</p></div></a>
